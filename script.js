...
const arrayNumbers = [new Slot("7", 1, "img/7.jpg"), new Slot("Bar", 2, "img/bar.jpeg"), new Slot("Fruit", 3, "img/Bonus-Fruits.png"), new Slot("Diamond", 4, "img/diamond.jpg")];
const arraySlots = [
...
btn.addEventListener("click", () => {
  ...
  setTimeout(() => {
    if (arraySlots[0].point == arraySlots[1].point && arraySlots[1].point == arraySlots[2].point) count++;

    if (arraySlots[3].point == arraySlots[4].point && arraySlots[4].point == arraySlots[5].point) count++;

    if (arraySlots[6].point == arraySlots[7].point && arraySlots[7].point == arraySlots[8].point) count++;
